...
- 📈 **Advanced Metrics** - Evaluated using Precision, Recall, and NDCG
...
2.  **Item-Based CF** - Recommends based on similar movies
3.  **SVD (Matrix Factorization)** - Latent factor decomposition
4.  **Hybrid** - Combines Item-Based + SVD ⭐ **Best Performance**
...
The models were evaluated using a rigorous train/test split strategy. The **Hybrid Model** achieved the best balance of accuracy and ranking quality.

| Model | Precision@10 | Recall@10 | NDCG@10 | Coverage |
|-------|--------------|-----------|---------|----------|
| User-Based CF | 0.3203 | 0.2095 | 0.3837 | 0.2004 |
| Item-Based CF | 0.2908 | 0.1871 | 0.3514 | 0.1153 |
| SVD (MF) | 0.3060 | 0.2078 | 0.3694 | 0.2705 |
| **Hybrid** | **0.3284** | **0.2167** | **0.3908** | **0.2122** |

  * **Precision@10:** Measures how many recommended items were actually relevant (32.8% for Hybrid).
  * **NDCG@10:** Measures the ranking quality (higher score means better movies appear at the top).
  * **Coverage:** Represents the percentage of all available movies the model is able to recommend.
...
## 🎓 Learning Outcomes
  ...
  - ✅ Multiple ML model comparison (SVD, Hybrid, CF)
